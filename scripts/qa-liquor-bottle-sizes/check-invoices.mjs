...
await run('credit reason precedes totals, links the original and never auto-confirms','credit',async({doc,log})=>{
  ...
  assert.match(panel.textContent,/confirming does not enter a credit/);
