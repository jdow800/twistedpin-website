...
if(mode==='marked') {line.annotation='One keg short';invoice.reviewNotes=[];invoice.handwrittenNotes=[];}
...
window.fetch=async(url,options={})=>{
  ...
  if(path.endsWith('/invoices/test-invoice'))return json(detail);
  ...
  if(path.endsWith('/received')){line.receivedQty=String(JSON.parse(options.body).receivedQty);return json({ok:true});}
