...
| `/reserve/nye` ✅ built AT ITS REAL SLUG | `/reserve/nye` (no rename — same exact-match-redirect mechanic as birthdays) | NYE Party VIP Lanes 124 (add-on 125 rides along; lane stepper, max 6) |
