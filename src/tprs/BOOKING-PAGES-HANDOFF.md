...
| `/reserve/nye` ✅ built AT ITS REAL SLUG | `/reserve/nye` (no rename — same exact-match-redirect mechanic as birthdays) | NYE Party Lanes — VIP 124 + Traditional 126 (add-on 125 rides along; lane stepper, max 6 each; calendar seeded 12/31 via `defaultDate`) |
