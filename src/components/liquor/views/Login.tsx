...
/**
 * PIN login — land straight on the pad. The PIN itself identifies the staffer
 * (no "who are you?" pick first). On success the backend sets the staff session
 * cookie; onLoggedIn re-bootstraps the app (fetches the full actor + perms).
 */
