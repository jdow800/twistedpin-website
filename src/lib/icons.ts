...
export type IconKey =
  ...
  | 'home'           // Back to homepage (drawer affordance for V4/V8 friction)
  // Seasonal
  | 'sparkles'       // NYE / festive seasonal items
  | 'sun'            // Summer Pin Pass / warm-weather seasonal items
  // UI utilities
...
export const ICON_PATHS: Record<IconKey, string> = {
  ...
  // lucide.dev/icons/sun — central circle + 8 rays at compass points
